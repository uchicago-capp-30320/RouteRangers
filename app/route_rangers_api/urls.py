...
urlpatterns = [
    ...
    path("survey/", views.survey_p1, name="survey"),
    path("survey2/", views.survey_p2, name="survey_p2"),
    path("survey3/", views.survey_p3, name="survey_p3"),
    path("survey4/", views.survey_p4, name="survey_p4"),
